...
flux_frac_dir = f'path_to_your_flux_fraction_dicts_folder' # e.g., flux_fraction_dicts_T_hot={T_hot_in_K:.1e}_tau={tau:.2f}
...
np.savez(output_file_path, flux=flux_frac_line_dict, Ps=p_arr, Mrels=mach_rel_arr, tau = tau)
